...
<div class="wrapper">
  ...
  {{-- <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/voer-logo.png" alt="AdminLTELogo" height="60" width="60">
  </div> --}}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">{{ $users[0]->last_name }}</a>
        </div>
      </div>
      ...
      <!-- Sidebar Menu -->
{{-- @include('backend.layouts.sliderBar') --}}
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="card">
              <div class="card-header border-0" style="background-color: #28a745">
                <h3 class="card-title">Tác giả tiêu biểu</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr>
                    <td>
                      {{ $featured_author->fullname }}
                    </td>

                    <td>
                      {{ $featured_author->affiliation }}
                    </td>
                    
                    <td>
                      {{ $featured_author->national }}
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
