          ...
          <div class="card card-primary">
            ...
            <div class="card">
              <div class="card-header" style="background-color: #007bff;">
                <h1 class="card-title" style="color: #fff">Thêm tài liệu mới</h1>
              </div>
              @if ($errors->any())
              ...
              ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="categories" class="form-control @error('categories') is-invalid @enderror"
                    id="categories" placeholder="nhập vào danh mục của bài viết" value="{{ old('categories') }}">
                  @error('categories')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="author" class="form-control @error('author') is-invalid @enderror"
                    id="author" placeholder="nhập vào ID của tác giả" value="{{ auth()->user()->username }}" disabled>
                  @error('author')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
                ...
                <a href="{{ route('admin.index') }}"><button class="btn btn-danger btn-close"
