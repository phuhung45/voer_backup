                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header border-0">
                                <h3 class="card-title">Danh sách tài liệu đã ẩn</h3>
                                        ...
                                        <tr class="mode-material-delete-change-status-functionex-{{$material->id}}">
                                                ...
                                                <td class ="test">
                                                    <a href="{{ route('admin.edit', $material->material_id) }}"
                                                        ...
                                                        <p href="#" style="margin: auto" data-mode-name="material-delete" data-mode-id="{{ $material->id }}"  data-method="DELETE" class="btn-load-url-confirm btn btn-danger" data-href="{{ route('admin.destroy', $material->id) }}"
