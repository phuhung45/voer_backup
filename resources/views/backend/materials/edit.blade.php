            ...
            @endif
              ...
              <div class="form-group">
                ...
                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                    id="description"
                    placeholder="Mô tả bài viết">{!! old('description', $material->description) !!}</textarea>
                @error('description')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <div class="form-group">
                <label for="publish">Trạng thái bài viết</label>
                <select name="publish" class="form-control @error('publish') is-invalid @enderror" id="material_type">
                    <option value="0" {{ old('publish', $material->publish) === 0 ? 'selected' : ''}}>Ẩn</option>
                    <option value="1" {{ old('publish', $material->publish) === 1 ? 'selected' : ''}}>Hiện</option>
                </select>
                @error('publish')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
