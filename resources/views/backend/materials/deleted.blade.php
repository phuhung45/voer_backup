                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header border-0">
                                <h3 class="card-title">Danh sách tài liệu trong thùng rác</h3>
                                ...
                                <table class="table table-striped table-valign-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="mode-material-delete-change-status-functionex-{{$material->id}}">
                                                ...
                                                <td class ="test">
                                                    <a href="{{ route('admin.undeleted', $material->id) }}"
                                                        onclick="return confirm('Bạn có chắc muốn phục hồi bài viết?')"
                                                        class="btn btn-primary"><i
                                                        class="fa-solid fa-rotate-left"></i></a>
                                                    
                                                        <p href="#" style="margin: auto" data-mode-name="material-delete" data-mode-id="{{ $material->id }}"  data-method="DELETE" class="btn-load-url-confirm btn btn-danger" data-href="{{ route('admin.confirm_destroy', $material->id) }}"
