...
<body class="sidebar-mini sidebar-open" style="height: auto;">
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{ asset('dist/img/voer-logo.png') }}" alt="AdminLTELogo" height="60"
            width="60">
    </div>
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('admin.index') }}" class="brand-link">
                <img src="{{ asset('dist/img/voer-logo.png') }}" alt="VOER Logo"
                ...
                <div class="form-inline">
                    <div class="input-group" data-widget="sidebar-search">
                        <form action="{{ route('admin.search') }}" method="GET">
                            <input type="search" class="form-control form-control-sidebar" name="keyword" value=""
                                style="width: 100%; margin-right: 50px;" placeholder="Search">
